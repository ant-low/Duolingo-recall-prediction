...
Big Data Processing: Implemented a chunking strategy to process 13 million rows of raw data in blocks of 500,000.  
* Feature Engineering: 
...
# Data Access:
Due to GitHub's file size limits, the raw Duolingo dataset is not included here.
* Download: Duolingo Dataset on Kaggle
* Setup: Place learning_traces.zip in the /data folder to run the analysis.
